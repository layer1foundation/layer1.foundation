const copy = {
    donate:{
        chapter0:{
            ...
            headingBig:true,
            subheading:"LAYER 1 FOUNDATION IS A REGISTERED NONPROFIT CURRENTLY UNDER REVIEW FOR 501C6 STATUS IN THE UNITED STATES. CONTRIBUTIONS MADE TO L1F ARE NOT TAX DEDUCTIBLE BUT MAY QUALIFY AS BUSINESS EXPENSES PENDING YOUR JURISDICTION.",
            subsection1:{
                title:'WHY DONATE',
                smallText:true,
                paragraphs:[
